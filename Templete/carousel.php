  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      ...
      <div class="carousel-caption">
        <h5 class="d-none d-md-block"><a href="login.php" class="text-uppercase font-weight-bolder text-decoration-none text-white px-5 text-center btn btn-outline-danger">Login</a></h5>
