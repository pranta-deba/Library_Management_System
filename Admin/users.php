...
$total = "select count(*) as total from users where role='students'";
$totalresult = $conn->query($total);
$totalusers = $totalresult->fetch_assoc();
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
    ...
    <div class="ms-5 mt-2">
        <a class="btn" href="index.php">Dashboard</a>/<a class="btn" href="users.php">Users</a>
    </div>
    ...
    <div class="container" id="box1">
        <div class="row">
            <div class="col-lg-12 p-3">
                <h1> <i class="fa fa-tachometer" aria-hidden="true"></i> Total Users : <?= $totalusers['total'] ?></h1>
                <hr />
            </div>
        </div>
